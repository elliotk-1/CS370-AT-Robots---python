...
while running:
    if (SCREEN_WIDTH, (SCREEN_HEIGHT + UI_HEIGHT)) != screen.get_size():
        ...
        tmpX = player.rect.left
        tmpY = player.rect.top
        player.rect = player.image.get_rect()
        player.rect.left = tmpX
        player.rect.top = tmpY
        tmpX = player2.rect.left
        tmpY = player2.rect.top
        player2.rect = player2.image.get_rect()
        player2.rect.left = tmpX
        player2.rect.top = tmpY
